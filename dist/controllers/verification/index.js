"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }const Boom = require('boom');
var _user = require('../../models/user'); var _user2 = _interopRequireDefault(_user); // Adjust path based on your directory structure
...
const verifyEmail = async (req, res, next) => {
  ...
  try {
      const user = await _user2.default.findOne({ verificationToken: token });
